...
public extension Phony {
    ...
    func image(width: Int = 640, height: Int = 480) -> String {
        if Bool.random() {
    ...
    func image(width: Int = 640, height: Int = 480) -> URL {
        if Bool.random() {
            return self.unsplash(keyword: nil)
        }
        return self.picsum()
    ...
    func unsplash(width: Int = 640, height: Int = 480, category: UnsplashCategory = UnsplashCategory.allCases.randomElement()!, keyword: String? = nil) -> String {
    ...
    func unsplash(width: Int = 640, height: Int = 480, category: UnsplashCategory = UnsplashCategory.allCases.randomElement()!, keyword: String? = nil) -> URL {
        return URL(string: self.unsplash(width: width, height: height, category: category, keyword: keyword))!
    }

    func picsum(seed: String = UUID().uuidString, width: Int = 640, height: Int = 480) -> String {
        return "https://picsum.photos/seed/\(seed)/\(width)/\(height)"
    }

    func picsum(seed: String = UUID().uuidString, width: Int = 640, height: Int = 480) -> URL {
        return URL(string: self.picsum(seed: seed, width: width, height: height))!
    }

    func dataUri(width: Int = 640, height: Int = 480, color: String = "grey") -> String {
